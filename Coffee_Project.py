...
# Read in the data
tracts = gpd.read_file(r'../nyc_census_tract/tl_2012_36_tract_nysp.shp')
boros = gpd.read_file(r'../nyc_boroughs/boroughs.shp')
demography = pd.read_csv(r'../datasets/demog_data.csv')
coffee_data = pd.read_csv(r'../datasets/nyc_coffee.txt', '\t')
subway_stops = gpd.read_file(r'../nyc_subway_station/subway_stations.shp')
...
selected_tracts=tracts_w_counts.loc[(tracts_w_counts['count']<3) & (tracts_w_counts['per_fem']>24) & (tracts_w_counts['moe_medinc']>avg_income)]
